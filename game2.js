...
function HomeScreen() {
    ...
    function _create() {
        ...
        text = new createjs.Text("Mmi Game 2", "50px bowlby_oneregular", "#000000");
        text.y = -70;
        ...
        text = new createjs.Text("Tape les monstres et ne bute pas le cochon !", "20px bowlby_oneregular", "#000000");
        text.textAlign = "center";
        _container.addChild(text);
